...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Quadrado By Garbosa", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 1.0f, 0.0f, 4.0f, 1.0f); //enviando cor para variável uniform inputColor
